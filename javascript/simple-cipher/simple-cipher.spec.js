...
// import Cipher from './simple-cipher-alt'; //alternative from the community - noice!!!

console.log(`######################
######################
this is mine. also found a nice solution from community
- change the import in the test
######################
######################`);
